...
```{r}
mod4_ar1 <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                random = ~ 1|block/krate_kgha/nrate_kgha,
...
```{r}
mod5_arma11 <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                   random = ~ 1|block/krate_kgha/nrate_kgha,
...
```{r}
mod6_exp <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                random = ~ 1|block/krate_kgha/nrate_kgha,
...
# Model 7 - Gaussian  
```{r}
mod7_gaus <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                 random = ~ 1|block/krate_kgha/nrate_kgha,
...
# Model 8 - Linear  
```{r}
mod8_lin <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                random = ~ 1|block/krate_kgha/nrate_kgha,
...
```{r}
mod9_rq <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
               random = ~ 1|block/krate_kgha/nrate_kgha,
...
```{r}
mod10_sph <- lme(yield_kgha ~ krate_kgha*nrate_kgha*fdap,
                 random = ~ 1|block/krate_kgha/nrate_kgha,
